...
├── diagrams/
│   ├── components.svg         # Rendered diagrams
│   └── dataflow.svg
├── architecture.md            # Raw OpenCode output
├── *.mermaid                  # Mermaid sources
└── .repo-explainer/
    └── coherence.json         # Generation manifest
```

**CLI Changes:**
- Output now highlights coherent docs first with 📚 section
- Technical artifacts shown separately with 🔧 section
...
- 📄 Files being read: `Reading: path/to/file.py`
- ⚙️  Commands running: `Running: List files in directory`
- ✏️  Files being written: `Writing: architecture.md`
- 🔍 Search patterns: `Searching: *.py`
...
#   ⚙️  Running: List files in the root directory
#   📄 Reading: /path/to/main.py
#   📄 Reading: /path/to/README.md
#   ✏️  Writing: architecture.md
```
